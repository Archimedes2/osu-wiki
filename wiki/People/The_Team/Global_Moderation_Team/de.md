...
**Globales Moderationsteam** (früher auch bekannt als Administratoren, globales Modteam oder “GreenBAT”), allgemein auch **GMT**, sind Mitglieder des Osu!staffs, die in erster Linie für die Moderation der Channel und für Fragen, die auf das Personal und die gesamte Gemeinschaft gerichtet sind, zuständig sind.

## Ein GMT werden

Der Weg, um ein Mitglied des **Globales Moderationsteam** zu werden, ist ein schwieriger und komplizierter Prozess. Potenzielle Mitglieder sind oft auf die Fähigkeit eine zweite Sprache zu sprechen angewiesen, dabei wird dann noch innerhalb des Teams über das Potenzial desjenigen als Teammitglied diskutiert.

## Pflichten und Verantwortung

Das globale Moderationsteam ist für das Wohlergehen der Chats/Foren zuständig und kümmern sich um reibungslose Interaktionen der Gemeinschaft. Sie sollten sich an ihnen wenden, wenn Sie Fragen in Bezug auf die Moderationsaspekte des Spieles haben, das würde auch (aber nicht beschränkt auf) Angelegenheiten im Chat (Silence, Belästigung) und im Forum (Spam) miteinbeziehen.
